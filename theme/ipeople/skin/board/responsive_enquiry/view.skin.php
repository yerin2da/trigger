...
<article id="bo_v" class="inner" style="width:<?php echo $width; ?>">
	...
	<div id="bo_v_top">
		...
		<ul class="btn_bo_user bo_v_com">
			<li><a href="<?php echo $list_href ?>" class="btn_b01 btn" title="목록"><i class="fa fa-list" aria-hidden="true"></i><span>목록</span></a></li>
<!--
...
-->
			...
			<li>
				<a href="#" class="btn_more_opt is_view_btn btn_b01 btn"><i class="fa fa-ellipsis-v" aria-hidden="true"></i><span>게시판 옵션</span></a>
...
-->
        	<div class="profile_info_ct">
				<span class="sound_only">작성자</span><div class="rb"><?php echo $view['name'] ?><!--<?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?>--></div>
				<span class="sound_only">작성일</span><div class="rb"><?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></div>
        		<span class="sound_only">조회</span><div class="rb">조회수 <?php echo number_format($view['wr_hit']) ?></div>
        		<span class="sound_only">댓글</span><div><a href="#bo_vc">댓글 <?php echo number_format($view['wr_comment']) ?></a></div>
    		</div>
    	</div>
    </section>
...
-->
        ...
        <!-- } 본문 내용 끝 -->
				...
				<div id="bo_v_con">
					<div id="bo_v_resume">
						<table>
							<tr>
								<th>업체명</th><td><?php echo $view['name'] ?></td>
							<tr>
							<tr>
								<th>연락처</th><td><?php echo $view['wr_1'] ?></td>
							<tr>
							<tr>
								<th>이메일</th><td><?php echo $view['wr_email'] ?></td>
							<tr>
						</table>
					</div>
					<br>
        ...
        <!-- }  추천 비추천 끝 -->
		<ul id="bo_v_btn">
			<li><a href="<?php echo $list_href ?>" title="목록" alt="목록" class="bbs_adm_btn btn_b01 btn"><img src="<?php echo $board_skin_url ?>/img/menu.svg"><span class="sound_only">목록</span></a></li>
			<?php if ($update_href) { ?>
			<li><a href="<?php echo $update_href ?>" title="수정" alt="수정" class="bbs_adm_btn btn_b01 btn"><img src="<?php echo $board_skin_url ?>/img/settings.svg"><span class="sound_only">수정</span></a></li>
			<?php } ?>
			<?php if ($delete_href) { ?>
			<li><a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;" title="삭제" alt="삭제" class="bbs_adm_btn btn_b01 btn"><img src="<?php echo $board_skin_url ?>/img/trash.svg"><span class="sound_only">삭제</span></a></li>
			<?php } ?>
			<?php if ($write_href) { ?>
			<li><a href="<?php echo $write_href ?>" title="등록" alt="등록" class="bbs_adm_btn btn_b01 btn"><img src="<?php echo $board_skin_url ?>/img/edit.svg"><span class="sound_only">등록</span></a></li>
			<?php } ?>
		</ul>
    </section>
