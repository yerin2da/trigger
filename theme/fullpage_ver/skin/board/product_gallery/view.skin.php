...
//lightslider
add_stylesheet('<link rel="stylesheet" href="' . $board_skin_url . '/css/lightslider.css">', 0);
add_javascript('<script src="' . $board_skin_url . '/js/lightslider.min.js"></script>', 0);
            ...
            <div id="img-gallery-wrapper">
                <ul id="img-gallery">
                    ...
                    for ($i = 0; $i < $view['file']['count']; $i++) {
                        if (!in_array($view['file'][$i]['image_type'], array(1, 2, 3))) continue;
                        
                        $thumb_200_file = thumbnail($view['file'][$i]['file'], $st_path, $st_path, 200, 0, false);
                    ?>
                        <li data-thumb="<?php echo $view['file'][$i]['path'] . '/' . $thumb_200_file; ?>" data-src="<?php echo $view['file'][$i]['path'] . '/' . $view['file'][$i]['file']; ?>">
                        
                        <a href="<?= G5_BBS_URL ?>/view_image.php?bo_table=<?= $bo_table ?>&amp;fn=<?= $view['file'][$i]['file'] ?>" target="_blank" class="view_image">
                        <?php
                        echo get_view_thumbnail('<img src="'.$view['file'][$i]['path'] . '/' . $view['file'][$i]['file'].'" style="width:100%;">', 600);
                        ?>
                        </a>
                        </li>
                    <?php
            ...
            <div class="spec">
                <table>
                    ...
                    <tr>
                        ...
                        <td><?php echo get_text($view[$k]); ?></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
