    ...
    <div id="ctt_con">
        ...
        <div class="section1">
            <div class="slide_wrap">
                <div class="bg_area slide1" style="background-image:url('http://test6.yyend.com/theme/ipeople/skin/content/ipeople_as/img/as_bg3.png')">
                    <div class="inner">
                        <div class="con_wrap">
                            <!-- 여기부터 내용 내용쓰기-->
                ...
                <div class="bg_area slide2" style="background-image:url('http://test6.yyend.com/theme/ipeople/skin/content/ipeople_as/img/as_bg.png')">
                    <div class="inner">
                        <div class="con_wrap">
                            <!-- 여기부터 내용 내용쓰기-->
                            <div class="text"><span>합리적인 가격</span>과 <span>최고의 기술력</span> I PEOPLE 서비스</div>
                ...
                <div class="con_wrap">
                    ...
                    <ul class="icon_wrap">
                        <li data-aos="fade-up" data-aos-duration="1000"data-aos-delay="200">
                            <div class="img_wrap" style="background-image:url('http://test6.yyend.com/theme/ipeople/skin/content/ipeople_service/img/service_icon1.png')">
                            </div>
                            <div class="text_wrap">
                        ...
                        <li data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                            <div class="img_wrap" style="background-image:url('http://test6.yyend.com/theme/ipeople/skin/content/ipeople_service/img/service_icon2.png')">
                            </div>
                            <div class="text_wrap">
                        ...
                        <li data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                            <div class="img_wrap" style="background-image:url('http://test6.yyend.com/theme/ipeople/skin/content/ipeople_service/img/service_icon3.png')">
                            </div>
                            <div class="text_wrap">
